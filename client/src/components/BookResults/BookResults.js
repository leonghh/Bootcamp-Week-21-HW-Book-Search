...
function BookResults(props) {
    ...
    if (props.deleteButton){
        saveOrDeleteButton = (
            <button onClick={deleteButtonHandler} className="btn btn-dark" style={{ marginLeft: '.5rem' }}>
            Delete
            </button>
        )
    } else {
        saveOrDeleteButton = (
            <button onClick={saveButtonHandler} className="btn btn-dark" style={{ marginLeft: '.5rem' }}>
            Save
            </button>
        )
    } 
    ...
    smallThumbnailDisplay = smallThumbnail;
                ...
                <div className="row mb-3">
                    ...
                    <div className="col-md-5">
                        <div className="pull-right">
                            <a href={infoLilnk} className="btn btn-dark" target="_blank" rel="noopener noreferrer">Detail</a>
                            {saveOrDeleteButton}
                        </div>
                    </div>
                </div>
